...
import com.hnxyhcz.designPatterns.strategyPattern.factory.CashFactory;
...
public class CashMain {
	...
	private void btnOk_Click(Cash cash) {
		...
		totalPrices = csuper.acceptCash(Double.parseDouble(cash.getPrice()) 
				* Double.parseDouble(cash.getNumber()));
		total += totalPrices;
